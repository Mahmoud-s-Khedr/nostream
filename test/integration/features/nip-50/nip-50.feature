Feature: NIP-50
  ...
  Scenario: NIP-11 does not advertise NIP-50 extensions
    When a client requests the relay information document
    Then the supported_nip_extensions field is empty

  Scenario: Unsupported search extensions are ignored
    Given someone called Alice
    And someone called Bob
  ...
  Scenario: COUNT ignores unsupported search extensions
    Given someone called Alice
    And someone called Bob
